...
## Conclusion
ACDC is an exciting first step towards automating the circuit discovery process in neural networks. Figuring out ways to automate this process is crucial for making the mechanistic interpretability work scale to larger models and more complex tasks.
